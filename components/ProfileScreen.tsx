...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ username, rating, rank }) => {
  return (
    <div className="flex flex-col items-center h-full p-4 md:p-6 bg-gray-900 text-white overflow-y-auto">
        ...
        <div className="w-full max-w-md bg-gray-800/50 p-6 rounded-lg shadow-lg text-center">
            ...
            <div className="text-3xl font-bold text-cyan-400 mt-1">{username}</div>
            ...
            <div className="mt-6 border-t border-gray-700 pt-6">
                ...
                <div className="text-4xl font-bold font-mono text-white mt-2">{rating}</div>
            </div>
