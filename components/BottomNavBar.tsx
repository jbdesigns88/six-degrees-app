...
const BottomNavBar: React.FC<{ currentView: View, onNavigate: (path: string) => void }> = ({ currentView, onNavigate }) => {
        ...
        <nav className="fixed bottom-0 left-0 right-0 h-16 bg-gray-800/90 backdrop-blur-sm border-t border-gray-700 z-50">
            <div className="flex justify-around items-center h-full max-w-lg mx-auto">
                <NavItem
                    ...
                    isActive={currentPath === '' || currentPath === 'start' || currentPath === 'lobby'}
                    onClick={() => navigate('/')}
                />
                 <NavItem
                    label="Ranks"
