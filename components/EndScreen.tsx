...
const PathDisplay: React.FC<{ title: string, path: ConnectionNodeData[], target: Actor }> = ({ title, path, target }) => (
    <div className="flex flex-col items-center bg-gray-800/50 p-4 rounded-lg w-full">
...
const EndScreen: React.FC<EndScreenProps> = ({ win, lossReason, path, cpuPath, onPlayAgain, onChallenge, elapsedTime, target, gameMode }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full p-4 bg-gray-900 text-white overflow-y-auto">
